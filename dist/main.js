...
const task1 = new _Tasks__WEBPACK_IMPORTED_MODULE_13__.Task("Task","some task", " 12.12.2022", "Low", "Default");
console.log(task1.getTitle());

const project1 = new _projects__WEBPACK_IMPORTED_MODULE_14__.Project("New Project");
console.log(project1.getName());

console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_15__["default"])(new Date(2014, 1,11), "yyyy-MM-dd"));
